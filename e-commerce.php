        ...
        <section class="category" id="categories">
            ...
            <div class="category-container">
                ...
                <div class="category-column">
                    <div class="types">
                        ...
                        <a href="./includes/category.php?category=outdoor" class="Shop">Shop now <img src="./icon/right-arrow.png" class="arrow" alt="Arrow"></a>
                ...
                <div class="category-column">
                    <div class="types">
                        ...
                        <a href="./includes/category.php?category=hanging" class="Shop">Shop now <img src="./icon/right-arrow.png" class="arrow" alt="Arrow"></a>
            ...
            <div class="category-column">
                <div class="types">
                    ...
                    <a href="./includes/category.php?category=fruit" class="Shop">Shop now <img src="./icon/right-arrow.png" class="arrow" alt="Arrow"></a>
            ...
            <div class="category-column">
                <div class="types">
                    ...
                    <a href="./includes/category.php?category=popular" class="Shop">Shop now <img src="./icon/right-arrow.png" class="arrow" alt="Arrow"></a>            
                </div>
            ...
            <div class="category-column">
                <div class="types">
                    ...
                    <a href="./includes/category.php?category=new" class="Shop">Shop now <img src="./icon/right-arrow.png" class="arrow" alt="Arrow"></a>
    ...
    <div class="fcontain" >
        ...
        <div class="flist">
            ...
            <ul >
                ...
                <li><a href="./includes/category.php?category=indoor" >Shop</a></li>
                <li><a href="./includes/category.php?category=popular" >Plant Care</a></li>
